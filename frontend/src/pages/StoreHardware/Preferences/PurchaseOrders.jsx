...
function PurchaseOrders() {
  ...
  const [purchaseOrders, setPurchaseOrders] = useState(true);
  const [newPurchaseOrders, setNewPurchaseOrders] = useState(false);

  const handlePurchaseOrdersOpen = () => {
    setPurchaseOrders(false);
    setNewPurchaseOrders(true);
  };
  const handlePurchaseOrdersClose = () => {
    setPurchaseOrders(true);
    setNewPurchaseOrders(false);
  };
    ...
    <>
            ...
            <Tab.Container defaultActiveKey="general">
              ...
              <Tab.Content className="mt-4">
                <Tab.Pane eventKey="general">
                  <h5>When do you want your Purchase Orders to be closed?</h5>
                  <div className="bg-light d-flex flex-row a ">
                    <input type="radio" placeholder="" />{" "}
                    <p>When a Purchase Receive is recorded</p>
                    <input type="radio" />
                  ...
                  <div style={{ fontFamily: "sans-serif", padding: "20px" }}>
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={handlePurchaseOrdersOpen}
                      >
                        + New Custom Field
                      </button>
                    </div>
      ...
      {newPurchaseOrders && (
        ...
        >
          ...
          >
            <h5>New Custom Field - Purchase Orders</h5>
            <button
              style={{
                border: "none",
                background: "none",
              ...
              onClick={handlePurchaseOrdersClose}
            >
              &times;
            </button>
          </div>
