    ...
    <>
          ...
          <Tab.Container defaultActiveKey="general">
            ...
            <Tab.Content className="mt-4">
              <Tab.Pane eventKey="general">
                <h5>Cost Price Preference</h5>
                <div className="bg-light ">
                  <input type="checkbox" /> Allow users to override cost prices
                  in credit notes
                </div>
                <p
                  style={{
                ...
                >
                  Mark this option to allow users to manually edit and update
                  the cost price that is fetched from the recent transaction.
                  Once you override the cost price, the latest cost price will
                  not be updated based on the recent transaction.
                </p>
                <hr />

                <h5>Credit Note QR Code</h5>
                <p style={{ fontSize: "14px" }}>
                  Enable and configure the QR code you want to display on the
                  PDF copy of an Credit Note. Your customers can scan the QR
                  code using their device to access the URL or other information
                  that you configure.
                </p>
      ...
      {newCredit && (
        ...
        >
          ...
          >
            <h5>New Custom Field - Credit Notes</h5>
            <button
              style={{
                border: "none",
                background: "none",
