         ...
         <Col sm={9} className="pt-3">
                  ...
                  <Tab.Container defaultActiveKey="general">
                    ...
                    <Tab.Content className="mt-4">
                      ...
                      <Tab.Pane eventKey="field" onClick={handleBillOpen}>
                        <div
          ...
          <form>
            ...
            <div className="mb-3">
              ...
              >
                ...
                <option value="text">Details Page Menu</option>
                <option value="number">List Page - Action Menu</option>
                <option value="date">List Page - Bulk Action Menu</option>
              </select>
            </div>
