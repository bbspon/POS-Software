...
function DeliveryChallans() {
  ...
  const [deliveryChallen, setDeliveryChallen] = useState(true);
  const [newDeliveryChallen, setNewDeliveryChallen] = useState(false);

  const handleNewDeliveryChallenOpen = () => {
    setDeliveryChallen(false);
    setNewDeliveryChallen(true);
  };
  const handleNewDeliveryChallenClose = () => {
    setDeliveryChallen(true);
    setNewDeliveryChallen(false);
  };
                    ...
                    <div style={{ fontFamily: "sans-serif", padding: "20px" }}>
                      ...
                      >
                        ...
                        <button
                          ...
                          onClick={handleNewDeliveryChallenOpen}
                        >
                          + New Custom Field
                        </button>
                      </div>
        ...
        >
          ...
          >
            ...
            <button
              ...
              onClick={handleNewDeliveryChallenClose}
            >
              &times;
            </button>
          </div>
