...
import { Container, Dropdown, Row, Col, Nav, Tab, Form, Button, ButtonGroup } from "react-bootstrap";
import { IoAddCircleSharp } from "react-icons/io5";
function SalePerferences() {
    ...
    <>
                ...
                <Tab.Pane eventKey="general">
                  ...
                  {enablePriceList && (
                    <Form.Check
                      ...
                      onChange={(e) => setApplyPriceListLine(e.target.checked)}
                      className="ms-4"
                    />
                  )}
      ...
      {newSale && (
          ...
          <div className="d-flex justify-content-between">
            <h5><strong>New Custom Field - Sales Orders</strong></h5>
            <span role="button"  style={{ cursor: 'pointer' }} onClick={handleNewSaleClose}>✖</span>
          </div>
          <hr />
...
export default SalePerferences;
