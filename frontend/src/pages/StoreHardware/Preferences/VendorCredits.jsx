...
function VendorCredits() {
  ...
  const [vendorCredits, setVendorCredits] = useState(true);
  const [newVendorCredits, setNewVendorCredits] = useState(false);

  const handleVendorCreditsOpen = () => {
    setVendorCredits(false);
    setNewVendorCredits(true);
  };

  const handleVendorCreditsClose = () => {
    setVendorCredits(true);
    setNewVendorCredits(false);
  };
                ...
                <div style={{ fontFamily: "sans-serif", padding: "20px" }}>
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={handleVendorCreditsOpen}
                    >
                      + New Custom Field
                    </button>
                  </div>
