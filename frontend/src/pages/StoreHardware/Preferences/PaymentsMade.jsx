...
function PaymentsMade() {
   ...
   const [paymentsMade, setPaymentsMade] = useState(true);
   const [newPaymentsMade, setNewPaymentsMade] = useState(false);

   const handlePaymentsMadeOpen = () => {
     setPaymentsMade(false);
     setNewPaymentsMade(true);
   }
   const handlePaymentsMadeClose = () => {
     setPaymentsMade(true);
     setNewPaymentsMade(false);
   }
   ...
   <>
         ...
         <Col sm={9} className="pt-3">
                  ...
                  <Tab.Container defaultActiveKey="general">
                    ...
                    <Tab.Content className="mt-4">
                      ...
                      <Tab.Pane eventKey="field" onClick={handlePaymentsMadeOpen}>
                        <div
     ...
     {newPaymentsMade && (
        ...
        >
          ...
          >
            <h5>New Custom Field - Payments Made</h5>
            <button
              style={{
                border: "none",
                background: "none",
              ...
              onClick={handlePaymentsMadeClose}
            >
              &times;
            </button>
          </div>
